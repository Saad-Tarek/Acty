          ...
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <div className="flex w-full flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
                <img
                  ...
                  src="https://cdn.jsdelivr.net/npm/@material-symbols/svg-500@latest/rounded/running_with_errors.svg"
                />
              </div>
            ...
            <div className="flex w-full flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
                <img
                  className="size-12 text-scheme-text"
                  src="https://cdn.jsdelivr.net/npm/@material-symbols/svg-500@latest/rounded/mindfulness.svg"
                />
              </div>
              <h3 className="mb-5 text-h4 font-bold md:mb-6">
                ヨガと瞑想で心身を整える
            ...
            <div className="flex w-full flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
                <img
                  className="size-12 text-scheme-text"
                  src="https://cdn.jsdelivr.net/npm/@material-symbols/svg-500@latest/rounded/hiking.svg"
                />
              </div>
              <h3 className="mb-5 text-h4 font-bold md:mb-6">
                ハイキングと自然体験
