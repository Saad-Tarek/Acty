...
const MEMBERS = [
  { img: portrait("1507003211169-0a1dd7228f2d"), name: "田中 健一" },
  { img: portrait("1614644147798-f8c0fc9da7f6"), name: "鈴木 由美" },
  { img: portrait("1492562080023-ab3db95bfbce"), name: "佐藤 太郎" },
  { img: portrait("1517841905240-472988babdf9"), name: "山田 美咲" },
  { img: portrait("1519345182560-3f2917c472ef"), name: "伊藤 翔太" },
  { img: portrait("1592621385612-4d7129426394"), name: "鈴木 麻衣" },
  { img: portrait("1500648767791-00dcc994a43e"), name: "田中 拓也" },
  { img: portrait("1544005313-94ddf0286df2"), name: "佐藤 由紀" },
];
          ...
          {MEMBERS.map((m, i) => (
            <div key={m.name} className="flex flex-col text-center">
              ...
              <div className="mt-5 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center md:mt-6">
                ...
                <a href="#" aria-label={`${m.name} X`}>
                  <XLogo className="size-6 p-0.5 text-scheme-text" />
                </a>
                <a href="#" aria-label={`${m.name} Dribbble`}>
